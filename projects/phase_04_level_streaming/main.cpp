...
constexpr const char* kWindowTitle = "Phase 04 - Level Streaming";
...
constexpr const char* kScreenshotPath = "assets/screenshots/phase_04_level_streaming.png";
constexpr const char* kTelemetryPath = "assets/profiles/phase_04_level_streaming.csv";
        ...
        while (SDL_PollEvent(&event) == 1) {
            if (event.type == SDL_QUIT) {
                ...
                if (event.key.keysym.sym == SDLK_ESCAPE) {
                    ...
                    char line[128];
                    lines.emplace_back("Phase 04 - Level Streaming");
                    ...
                    lines.emplace_back(line);
                    SaveScreenshotPNG(renderer.get(), kScreenshotPath, lines);
